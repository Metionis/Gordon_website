  ...
  return (
    <div className="footer1-container">
      <div className="sticker-container">
        <ol className="social">
          <li>
            <a href="https://www.facebook.com/profile.php?id=100045033931703" title="Facebook" className="facebook" target="_blank" rel="noopener noreferrer">
              <i className="fab fa-facebook-f"></i> {/* FontAwesome icon */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20px" height="20px" fill="black">
                <path d="M22.675 0h-21.35C.595 0 0 .593 0 1.326v21.348C0 23.407.595 24 1.326 24H12.82v-9.294H9.692v-3.622h3.128V8.41c0-3.1 1.893-4.788 4.657-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.505 0-1.796.716-1.796 1.764v2.312h3.59l-.467 3.622h-3.123V24h6.116C23.405 24 24 23.407 24 22.674V1.326C24 .593 23.405 0 22.675 0z"/>
              </svg>
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com/quanvan29/" title="Instagram" className="instagram" target="_blank" rel="noopener noreferrer">
          ...
          <li>
            <a href="https://www.youtube.com/channel/UCNgzbFz41quHhOVDrCYreQA" title="Youtube" className="youtube" target="_blank" rel="noopener noreferrer">
              <i className="fab fa-youtube"></i> {/* FontAwesome icon */}
              <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li>
            <a href="https://www.linkedin.com/" title="LinkedIn" className="linkedin" target="_blank" rel="noopener noreferrer">
